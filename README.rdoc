= Connamara fork details

See {this StackOverflow question}[http://stackoverflow.com/questions/37576561/ckeditor-toolbar-using-wrong-icon-file-via-rails-rich-gem]
and {connamara/cme-institute#3498}[https://github.com/connamara/cme-institute/issues/3498].

FI is using an old version of this gem (branched off of 3e92749ac).
Newer releases don't work for some reason that I (Grant) don't have
the time or interest to investigate it.

The only change in this fork is this:

<tt>vendor/assets/images/ckeditor$ cp plugins/icons.png skins/moono/icons.png</tt>


<b>Everything under this line is the original README.</b>
