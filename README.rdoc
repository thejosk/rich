...
See {this SO question}(http://stackoverflow.com/questions/37576561/ckeditor-toolbar-using-wrong-icon-file-via-rails-rich-gem)
...
Everything under this line is the original README.
